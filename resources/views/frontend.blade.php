...
$settings = [
    ...
    'app_description' => App\Models\Settings::where(['key' => 'app_description'])->first()?->value ?? 'Your Trusted Car Dealer',
    'app_keywords' => '',
    'app_author' => '',
    'app_favicon' => App\Models\Settings::where(['key'=>'app_favicon'])->first()?->value ?? '/favicon.ico',
    'app_logo' => '',
];?>
...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/lightbox2/2.11.4/css/lightbox.min.css" integrity="sha512-ZKX+BvQihRA8CROKBhDNvoc2aDMOdAlcm7TUQY+35XYtrd3yh95QOOhsPDQY9QnKE0Wqag9y38OIgEvb88cA==" crossorigin="anonymous" referrerpolicy="no-referrer" />

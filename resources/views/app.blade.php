<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="layout-navbar-fixed layout-menu-fixed" id="layout-navbar-fixed">
@php
$settings = [
...
<body>
    ...
    <script src="{{ asset('/backend/assets/js/menu.js')}}"></script>
    <script src="{{ asset('/backend/assets/js/helpers.js')}}"></script>
    <!-- Main JS -->

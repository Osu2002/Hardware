<template>
  ...
  >
    <div class="carousel-inner">
      <div class="carousel-item d-block custom_slide_height position-relative">
        ...
        <div
          class="carousel-caption custom_caption_position"
          style="top: 90%"
        >
          <div class="caption">
            <h1 class="main-topic-banner">Vehicle Leasing</h1>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      imageSrc: "/images/Background%20(6).png",
    };
  },
  methods: {
    onImageLoad() {

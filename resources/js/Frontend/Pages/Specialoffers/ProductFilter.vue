...
<style scoped>
/* SAME AS FEATURED */
.filters-shell { position: relative; align-self: start; }
.filters { background:#fff; border:1px solid #e5e7eb; border-radius:12px; padding:14px; z-index:20; }
.filters.is-desktop-sticky { position: sticky; top: 12px; }

.filters-header { display:flex; align-items:center; justify-content:space-between; gap:12px; margin-bottom:10px; }
.filters-title { margin:0; font-size:1rem; font-weight:800; color:#111827; }
.filters-actions { display:inline-flex; align-items:center; gap:10px; }

.btn-clear { border:0; background:transparent; color:#ef4444; font-weight:700; cursor:pointer; white-space:nowrap; }

.btn-toggle { border:1px solid #e5e7eb; background:#fff; border-radius:10px; width:34px; height:34px; display:inline-flex; align-items:center; justify-content:center; cursor:pointer; }
.btn-toggle:hover { background:#f9fafb; }
.toggle-icon { transition: transform .18s ease; color:#111827; }

.filter-block { padding:12px 0; border-top:1px solid #f3f4f6; }
.filter-label { font-weight:800; color:#111827; font-size:.9rem; margin-bottom:8px; }

.opt { display:flex; align-items:center; gap:10px; font-size:.9rem; color:#374151; margin:6px 0; cursor:pointer; user-select:none; }

.sort-select { width:100%; height:38px; border:1px solid #e5e7eb; border-radius:10px; padding:0 10px; outline:none; }

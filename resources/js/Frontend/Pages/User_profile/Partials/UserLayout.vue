                ...
                <div class="card shadow-sm mb-5 bg-white border">
                    <div class="card-body">
                        <div class="text-center position-relative">
                            <div
                                v-if="!avatarLoaded"
                                class="skeleton-placeholder rounded-circle"
                            ></div>
                                ...
                                <div class="tab-content" id="v-pills-tabContent">
                                    ...
                                    <div class="tab-pane fade" id="v-pills-affiliate" role="tabpanel"
                                        ...
                                        <div class="m-auto text-center" style="max-width:400px" v-else-if="$page.props.logged_customer?.enrolled_affiliate == 1">
                                            <h3 class="text-gradient">Pending Affiliate Approval</h3>
                                            <br>
                                        ...
                                        <div class="m-auto text-center" v-else>
                                            <button @click="enrollAffiliate" class="btn btn-gradient">Enroll to affiliate program.</button>
                                        </div>
                                    </div>
...
//   },
    ...
    computed: {
    avatarSrc() {
        const media = this.$page.props.logged_customer?.media;

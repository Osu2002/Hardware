                ...
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        ...
                        <div class="d-flex">
                            ...
                            <button v-else class="btn btn-main btn-sm" disabled>
...
export default {
    ...
    computed: {
        canCreate() {
            // you could also include your permission check here
            return (
                this.$root.hasPermission("country.create") &&
    ...
    mounted() {
        $("#mytable").on("draw.dt", () => {
            const info = $("#mytable").DataTable().page.info();
            this.countriesCount = info.recordsTotal;
        });

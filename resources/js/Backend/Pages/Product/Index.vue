        ...
        <div class="modal-dialog modal-sm" role="document">
          <div class="modal-content">
            ...
            <form @submit.prevent="deleteSelectedItems">
              <div class="modal-body py-0 px-3"><p>Delete selected product(s)?</p></div>
...
export default {
  ...
  data() {
    return {
      columns: [
        ...
        { mData: "sku", name: "sku", orderable: true, searchable: true },
        { mData: "brand", name: "brand", orderable: true, searchable: true },
        { mData: "uom", name: "uom", orderable: true, searchable: true },
        { mData: "price", name: "price", orderable: true, searchable: true },
  ...
  mounted() {
    ...
    $("#mytable tbody").on("click", "tr .action_edit", (evt) => {
      const id = $(evt.target).data("item-id");
      this.$inertia.visit(route("product.edit", id));
    });
  ...
  methods: {
    ...
    updateStatus(id, status){
      ...
      this.form.put(route("product.change.status"), {
        preserveScroll: true,

          ...
          <div class="card-body">
            ...
            <form id="formAccountSettings" @submit.prevent="submit">
              <div class="row">
                ...
                <div class="h5 my-4" v-if="form.role == 7">Dealer Bank Details</div>
                <div class="mb-3 col-md-6" v-if="form.role == 7">
                ...
                <div class="mb-3 col-md-6" v-if="form.role == 7">
                  <label for="branch" class="form-label">Branch</label>
                  <input class="form-control" type="text" id="branch" name="branch" v-model="form.branch" />
                  <div class="text-danger">
                    {{ form.errors.branch }}
                  </div>
                </div>
                <div class="mb-3 col-md-6" v-if="form.role == 7">
                  ...
                  <input class="form-control" type="number" id="acc_number" name="acc_number"
                    v-model="form.acc_number" />
                  <div class="text-danger">
                    {{ form.errors.acc_number }}
                  </div>
                </div>
                <div class="mb-3 col-md-6" v-if="form.role == 7">
                  <label for="payee_name" class="form-label">Payee Name</label>
                  <input class="form-control" type="text" id="payee_name" name="payee_name" v-model="form.payee_name" />
                  <div class="text-danger">
                ...
                <div class="mb-3 col-md-6" v-if="form.role == 7">
                  ...
                  <input class="form-control" type="text" id="branch_code" name="branch_code"
                ...
                <div class="h5 my-4"v-if="!backendUser">Authentication</div>
...
export default {
  ...
  mounted() {
    ...
    if (this.backendUser) {
      ...
      this.form.bank_name = this.backendUser.bank_name;
      this.form.branch = this.backendUser.branch;
      this.form.acc_number = this.backendUser.acc_number;
      this.form.payee_name = this.backendUser.payee_name;
      this.form.branch_code = this.backendUser.branch_code;
      this.form.passbook_image = this.backendUser.passbook_image;
      this.form.role =

      ...
      <div class="col-md-12">
        <div class="card mb-4">
          <div class="card-header pb-0">
            ...
            <p>Manage Vehicle.</p>
            <div class="d-flex">
              <Link class="btn btn-main btn-sm" :href="route('vehicle.create')"
          ...
          <div class="card-body">
            <data-table ref="datatable" :id="'mytable'" :url="route('vehicle.getdata')" :columns="columns"
          ...
          <div class="modal-content">
            ...
            <form id="formAccountDelete" @submit.prevent="deleteSelectedItems">
              ...
              <div class="modal-footer px-3 pb-3">
                <button type="button" class="btn btn-sm btn-label-secondary" data-bs-dismiss="modal" @click="resetForm">
                  Close
                </button>

<!-- resources/js/Pages/Catalog/Uom/Index.vue -->
<template>
  <AppLayout>
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="modal-dialog modal-sm" role="document">
          <div class="modal-content">
            ...
            <form @submit.prevent="deleteSelectedItems">
              <div class="modal-body py-0 px-3"><p>Are you sure you want to delete?</p></div>
...
export default {
  ...
  data() {
    return {
      columns: [
        ...
        { mData: "sort_order", name: "sort_order", orderable: true },
  ...
  mounted() {
    ...
    $("#mytable tbody").on("click", "tr .action_edit", (evt) => {
      const id = $(evt.target).data("item-id");
      this.$inertia.visit(route("uom.edit", id));
    });
  ...
  methods: {
    ...
    updateStatus(id, status) {
      ...
      this.form.put(route("uom.change.status"), {
        preserveScroll: true,

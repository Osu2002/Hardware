...
class RolesPermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permission_array = [
            ...
            //leads
            ['section_name' => 'lead', 'name' => 'lead.view'],
            ['section_name' => 'lead', 'name' => 'lead.create'],
            ['section_name' => 'lead', 'name' => 'lead.edit'],
            ['section_name' => 'lead', 'name' => 'lead.delete'],
            //dealer
            ['section_name' => 'dealer', 'name' => 'dealer.view'],
            ['section_name' => 'dealer', 'name' => 'dealer.create'],
